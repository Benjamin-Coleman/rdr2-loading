...
import { generateBlurVertSource } from "./generateBlurVert";
import { generateBlurFragSource } from "./generateBlurFrag";
...
export class BlurFilterPass extends Filter {
    ...
    apply(filterManager, input, output, clearMode) {
        ...
        // screen space!
        this.uniforms.strength *= this.customUniforms.blur;
        ...
        if (this.passes === 1) {
            ...
            for (let i = 1; i < this.passes - 1; i++) {
                filterManager.bindAndClear(flip, 2);
